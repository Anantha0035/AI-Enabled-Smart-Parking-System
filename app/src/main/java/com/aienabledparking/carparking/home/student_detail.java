...
public class student_detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        telegram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://t.me/aienabledparkingsystem");
        ...
        instagram.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://www.instagram.com/aienabled_parking_system/");
        ...
        inquiry.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uriText = "mailto:" + Uri.encode("aienabledparkingsystem@gmail") + "?subject=" +
        ...
        faq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                gotoUrl("https://maps.app.goo.gl/4mVqrKdcquMiBN147");
