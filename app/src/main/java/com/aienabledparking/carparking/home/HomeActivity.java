package com.aienabledparking.carparking.home;
...
import com.aienabledparking.carparking.Booking.Slot_area;
import com.aienabledparking.carparking.Booking.booking_slot1;
import com.aienabledparking.carparking.R;
import com.aienabledparking.carparking.login.LoginandregisterActivity;
import com.aienabledparking.carparking.profile.driver_page;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        feedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String uriText = "mailto:" + Uri.encode("aienabledparkingsystem@gmail.com") + "?subject=" +
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.About) {
            ...
            Intent intent = new Intent("android.intent.action.VIEW",
                    Uri.parse("https://maps.app.goo.gl/DoToKQcnwXsfrixS9"));
            ...
            if(Build.VERSION.SDK_INT<23){
                Intent in=new Intent(Intent.ACTION_CALL, Uri.parse("tel:+91" + "6281902423"));
